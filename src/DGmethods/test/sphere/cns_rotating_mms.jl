...
include("cns_rotating_mms_generated_solution.jl")
...
function initialcondition!(Q, t, x, y, z, _...)
  DFloat = eltype(Q)
  ρ::DFloat = ρ_g(t, x, y, z)
  U::DFloat = U_g(t, x, y, z)
  V::DFloat = V_g(t, x, y, z)
  W::DFloat = W_g(t, x, y, z)
  E::DFloat = E_g(t, x, y, z)
...
let
  ...
  base_num_elem = 4
  if integration_testing
    expected_result = Array{Float64}(undef, 3)
    expected_result[1] = 3.3669188610024728e-02
    expected_result[2] = 1.7603468555920912e-03
    expected_result[3] = 9.1108572847298699e-05
    lvls = size(expected_result, 2)
  else
    expected_result = Dict{Tuple{Int64, DataType}, AbstractFloat}()
    expected_result[1, Float64] = 1.0099522817205739e+00
    expected_result[3, Float64] = 1.0099521111150005e+00
    lvls = 1
  end
